"""
Tests for H06 Airglow Inversion.
Spec:    specs/H06_airglow_inversion_2026-05-05.md
Tests:   T1–T8
Run with: pytest tests/test_h06_airglow_inversion.py -v
"""
import numpy as np
import pytest

from src.fpi.m06_airglow_inversion_2026_05_05 import (
    AirglowFitResult,
    AirglowFitFlags,
    fit_airglow_fringe,
)
