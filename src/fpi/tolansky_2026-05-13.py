...
Repo:        soc_sewell
Input:       {stem}_peak_fits_r2.npy  (9- or 10-column float64,
             from annular_reduction_2026-05-13.py)
             Family assignment:
               10-column: col 9 (line_id) used directly
                          0.0 -> 640.2248 nm (family a)
                          1.0 -> 638.2991 nm (family b)
                         -1.0 -> excluded with warning
               9-column:  median-amplitude threshold (legacy fallback)
Note:        Neon two-line calibration lamp analysis only (S13).
             Single-line airglow Tolansky (S13b) is not a pipeline step --
             airglow science images go directly from annular reduction to
             M06 Airy inversion using d, alpha, epsilon from this module.
Supersedes:  tolansky_2line_2026-05-05.py
"""
...
if __name__ == "__main__":
    ...
    result = run_tolansky_2line(peaks_path)
