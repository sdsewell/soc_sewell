"""
Module:      m01_airy_forward_model_2026_04_26.py
...
Changes from 2026_04_05:
  ...
  - All wavelengths and physical constants for new functions imported
    from src.constants.
...
# ---------------------------------------------------------------------------
# New in 2026_04_26 — source spectrum constructors (Harding Eqs 10–11)
# ---------------------------------------------------------------------------
