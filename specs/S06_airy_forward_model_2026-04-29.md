...
│   └── airy_forward_model_2026_04_29.py   ← this module
├── tests/
│   └── test_airy_forward_model_2026-04-29.py
└── docs/specs/
    ├── S06_airy_forward_model_2026-04-29.md   ← this file
    └── archive/
...
commit:
`feat(constants): add missing constants for S06 v2026-04-29`
...
Create `src/fpi/airy_forward_model_2026_04_29.py` by copying the
...
```python
"""
Module:      airy_forward_model_2026_04_29.py
Spec:        docs/specs/S06_airy_forward_model_2026-04-29.md
Author:      Claude Code
...
Create `tests/test_airy_forward_model_2026-04-29.py` by copying the
...
Run: `pytest tests/test_airy_forward_model_2026-04-29.py -v --tb=short`
...
2. Archive the old spec:
   ...
   ```
3. Copy this new spec to `docs/specs/S06_airy_forward_model_2026-04-29.md`.
...
TASK B — Module created
  Source file: src/fpi/airy_forward_model_2026_04_29.py
